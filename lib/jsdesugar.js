...
Narcissus.desugaring = (function() {
    ...
    function desugarArrayAssignment(lhs, tmp) {
        ...
        lhs.children.forEach(function(patt, i) {
            ...
            elts.push(desugarAssignment(new parser.SyntheticNode(lhs.tokenizer, {
                type: ASSIGN,
                children: [patt, path],
                blockComment: null
            })));
        ...
        return elts.length > 0
             ? list(lhs.tokenizer, elts)
             : new parser.SyntheticNode(lhs.tokenizer, { type: NULL, value: "null" });
    }
 ...
 */
    function desugarComprehension(node) {
        ...
        var body;
        if (genexp) {
            body = new parser.SyntheticNode(t, {
                type: SEMICOLON,
                value: "yield",
                expression: new parser.SyntheticNode(t, {
                    type: YIELD,
        ...
        var decl = null;
        if (!genexp) {
            decl = new parser.SyntheticNode(t, {
                type: VAR,
                value: "var",
                children: [new parser.SyntheticNode(t, {
                    type: IDENTIFIER,
        ...
        var fn = new parser.SyntheticNode(t, {
            type: FUNCTION,
            value: "function",
            params: [],
            paramComments: [],
        ...
        var call = new parser.SyntheticNode(t, {
            type: CALL,
            value: "(",
            children: [fn, new parser.SyntheticNode(t, { type: LIST, value: "(" })]
        });
