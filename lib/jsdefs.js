...
Narcissus.definitions = (function() {
    ...
    function blacklistHandler(target, blacklist) {
        ...
        return multiplexHandler(redirect, target);
    }
    ...
    function whitelistHandler(target, whitelist) {
        ...
        return multiplexHandler(redirect, catchall);
    }
    ...
    /*
     * Multiplex proxies break the single-inheritance model of prototypes, so
    ...
    function multiplexHandler(redirect, catchall) {
