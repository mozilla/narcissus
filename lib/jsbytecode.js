...
Narcissus.bytecode = (function() {
    ...
    var Binop = bytecodeClass({
        opcode: "Binop",
        constructor: function Binop(type) {
            function op(type) {
                switch (type) {
                  case BITWISE_OR:  return function(x, y) { return x | y }
                  case BITWISE_XOR: return function(x, y) { return x ^ y }
                  case BITWISE_AND: return function(x, y) { return x & y }
                  case EQ:          return function(x, y) { return x == y }
                  case NE:          return function(x, y) { return x != y }
                  case STRICT_EQ:   return function(x, y) { return x === y }
                  case STRICT_NE:   return function(x, y) { return x !== y }
                  case LT:          return function(x, y) { return x < y }
                  case LE:          return function(x, y) { return x <= y }
                  case GT:          return function(x, y) { return x > y }
                  case GE:          return function(x, y) { return x >= y }
                  case IN:          return function(x, y) { return x in y }
                  case INSTANCEOF:  return function(x, y) { return x instanceof y }
                  case LSH:         return function(x, y) { return x << y }
                  case RSH:         return function(x, y) { return x >> y }
                  case URSH:        return function(x, y) { return x >>> y }
                  case PLUS:        return function(x, y) { return x + y }
                  case MINUS:       return function(x, y) { return x - y }
                  case MUL:         return function(x, y) { return x * y }
                  case DIV:         return function(x, y) { return x / y }
                  case MOD:         return function(x, y) { return x % y }
                }
            }
            this.operator = type;
            this.name = definitions.tokens[type];
            this.callback = op(type);
        },
    ...
    var Unop = bytecodeClass({
        opcode: "Unop",
        constructor: function Unop(type) {
            function op(type) {
                switch (type) {
                  case DELETE:      return function(x) { return delete x }
                  case VOID:        return function(x) { return void x }
                  case TYPEOF:      return function(x) { return typeof x }
                  case NOT:         return function(x) { return !x }
                  case BITWISE_NOT: return function(x) { return ~x }
                  case UNARY_PLUS:  return function(x) { return +x }
                  case UNARY_MINUS: return function(x) { return -x }
                }
            }
            this.operator = type;
            this.name = definitions.tokens[type];
