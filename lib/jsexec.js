...
Narcissus.interpreter = (function() {
    ...
    function ExecutionContext(type) {
        ...
        if (type === GLOBAL_CODE && Narcissus.options.version === "harmony")
    ...
    var globalScope = Object.create(null, {}); // unexposed global scope record (Harmony)
    var narcissusGlobal = {};                  // exposed global scope object
    ...
    function executeModule(n, x) {
        ...
        var x2 = new ExecutionContext(MODULE_CODE);
        x2.scope = inst.scope;
        x2.thisObject = m;
        x2.thisModule = m;
        if (n.body)
    ...
    function evaluate(s, f, l) {
        ...
        if (Narcissus.options.version === "harmony") {
            resolver.resolve(ast, globalStaticEnv);
    ...
    return {
        ...
        globalStaticEnv: globalStaticEnv,
